  ...
  return (
    ...
    >
      <motion.form
        ...
        className="bg-netflix-black p-8 md:p-10 rounded-lg shadow-xl max-w-md w-full border border-netflix-gray"
        initial={{ y: -20, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ delay: 0.2 }}
      >
        <h2 className="text-3xl font-bold text-netflix-white mb-6 text-center">
          {isLogin ? 'Sign In' : 'Sign Up'}
        </h2>

        {error && (
          <div className="bg-red-700 text-white p-3 rounded-md mb-4 text-sm text-center">
            {error}
          </div>
        )}
        ...
        {!isLogin && (
          <div className="mb-4">
            <input
              ...
              className="w-full p-3 rounded-md bg-netflix-gray border border-transparent focus:border-netflix-red focus:outline-none text-white placeholder-netflix-light-gray"
              value={username}
          ...
          <>
            ...
            <div className="mb-4 flex items-center">
              <input
                type="checkbox"
                id="acceptTerms"
                className="form-checkbox h-5 w-5 text-netflix-red rounded border-netflix-gray focus:ring-0"
                checked={acceptTerms}
                onChange={(e) => setAcceptTerms(e.target.checked)}
              />
              <label htmlFor="acceptTerms" className="ml-2 text-netflix-light-gray text-sm">
        ...
        {isLogin && (
          <div className="mb-6 flex items-center justify-between">
            ...
            <Link to="#" className="text-netflix-light-gray hover:underline text-sm">
              Need help?
            </Link>
          </div>
        )}
        ...
        <button
          type="submit"
          className="w-full bg-netflix-red hover:bg-red-700 text-white font-bold py-3 rounded-md transition-colors duration-200"
          disabled={loading}
        >
        ...
        <div className="mt-6 text-center">
          <p className="text-netflix-light-gray text-sm">
            ...
            <button
              ...
              className="text-netflix-white hover:underline font-semibold"
            >
        ...
        <div className="mt-8">
          <div className="relative flex items-center justify-center py-4">
            <div className="flex-grow border-t border-netflix-gray"></div>
            <span className="flex-shrink mx-4 text-netflix-light-gray text-sm">OR</span>
            <div className="flex-grow border-t border-netflix-gray"></div>
          </div>
          <button
            type="button"
            className="w-full flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 rounded-md transition-colors duration-200 mb-3"
          ...
          <button
            type="button"
            className="w-full flex items-center justify-center bg-gray-700 hover:bg-gray-800 text-white font-bold py-2.5 rounded-md transition-colors duration-200"
